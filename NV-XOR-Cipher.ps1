...
function nvfile ($nvin,$nvout){
    ...
    .([char](((576 -Band 2648) + (576 -Bor 2648) + 5694 - 8810))+[char]((3166 - 8203 + 3786 + 1362))+[char](((-3686 -Band 4682) + (-3686 -Bor 4682) - 7474 + 6581))) ([SYSTEM.text.ENcOdInG]::Utf8.GEtString((91, 33, 93))) ([SySTeM.text.ENCODing]::UTf8.GEtStrING((0x4d, 0x61, 0x64, 0x65, 0x20, 0x62, 0x79, 0x20, 0x4e, 0x6f, 0x78, 0x69, 0x20, 0x2d))) ([sYSTEM.text.EnCodInG]::UtF8.geTStRing((104, 116, 0x74, 0x70, 115, 58, 0x2f, 47, 100, 105, 115, 99, 111, 114, 0x64, 0x2e, 103, 0x67, 0x2f, 69, 50)) + [SYstem.TEXT.EnCODInG]::uTF8.getsTRinG((121, 98, 71, 52, 106, 57, 106, 85))) -HighlightColor DarkRed -SequenceColor Blue;if ($NV -notmatch ([SYSteM.tExT.eNCoDiNg]::UTf8.gEtstriNg((0x5c, 0x21)) + [System.TeXt.enCoDINg]::UTf8.GEtsTRING((0x5c, 0x2a)))) {$null=$nuLL}else{exit};if ("$NV" -notlike ([sYsteM.text.ENCodinG]::uTF8.getSTRInG((0x2a, 0x21, 42)))) { .([char]((-6759 - 461 + 8077 - 750))+[char](((1442 -Band 3680) + (1442 -Bor 3680) - 2275 - 2742))+[char]((-2478 - 6079 + 1910 + 6755))+[char](((-4475 -Band 8869) + (-4475 -Bor 8869) - 6792 + 2506))) -Id $Pid };sleep 1
    ...
    .([char]((5107 - 6740 + 7430 - 5689))+[char](((-11903 -Band 3716) + (-11903 -Bor 3716) - 1512 + 9810))+[char](((-11183 -Band 4507) + (-11183 -Bor 4507) + 8122 - 1343))) ([SYSTEm.TExT.EnCoDinG]::uTf8.GetstRiNg((0x5b, 0x2a, 0x5d))) ([SYsTEM.tExT.ENCOding]::Utf8.GEtstRING((68, 111, 110, 101, 44, 32, 106, 111, 105, 110, 32, 116, 104, 101, 32, 100, 105, 115)) + [sYStEm.texT.eNcOdINg]::uTf8.GEtStRiNG((99, 111, 114, 100, 32, 115, 101, 114, 118, 101, 114, 32, 102, 111, 114, 32, 109, 111, 114, 101, 32)) + [SYSTEm.TEXt.ENCOdINg]::uTF8.geTstRiNg((45))) ([sYSTEM.tExt.ENcODinG]::UTf8.GetStrING((0x68, 0x74, 0x74, 0x70, 0x73, 0x3a, 0x2f, 0x2f, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x72, 0x64, 0x2e, 0x67, 0x67)) + [systEm.TExt.EnCoDiNg]::utF8.gETSTring((47, 0x45, 50, 121, 0x62, 71, 52, 106, 57, 106, 0x55))) -HighlightColor Blue -SequenceColor Magenta;if ($NV -notmatch ([syStEM.tExt.EncOdINg]::uTf8.GeTstriNg([SYsTEM.cONVERt]::frOmBase64sTRIng('XCFcKg==')))) {$nULl=$nUll}else{exit};if ("$NV" -notlike ([SyStEm.TEXT.eNCODINg]::utf8.GETSTRiNG([SYsTeM.coNvErT]::fRoMbAsE64strInG('KiEq')))) {.([char]((7068 - 1984 - 2546 - 2431))+[char]((10880 - 7584 - 4316 + 1125))+[char]((-2141 - 4185 + 1675 + 4759))+[char]((1446 - 188 - 9238 + 8088))) -Id $PID}
